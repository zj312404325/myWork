...
@ContentView(R.layout.activity_order_match_detail)
public class OrderMatchDetailActivity extends TopActivity implements IXListViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_match_detail);
        x.view().inject(this);
        ...
        sap = new ProSimpleAdapter(OrderMatchDetailActivity.this, dateMaps,
                R.layout.listview_ordermatch_detail,
                new String[]{"proName"},
    ...
    public class ProSimpleAdapter  extends SimpleAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            holder=null;
            if(convertView==null){
                convertView=mInflater.inflate(R.layout.listview_ordermatch_detail, null);
