		...
		try {
			...
			sellProductProps = resdata.getJSONArray("propsArr");
				...
				for(int i=0;i<xincengLstArr.length();i++){
			         ...
			         if(selectPro.getString("var2").equals( xincengLstArr.getString(i))){
			        	 map.put("s", 2);
			         }
			         else{			         
			        	 map.put("s", 0);
				...
				for(int i=0;i<baozhuangLstArr.length();i++){
			         ...
			         if(selectPro.getString("var3").equals( baozhuangLstArr.getString(i))){
			        	 map.put("s", 2);
			         }
			         else{			         
			        	 map.put("s", 0);
										...
										if(i == position1 && s != 0){
											...
											for(int j=0;j<sellProductProps.length();j++){
												...
												if(objtem.getString("var1").equals(var1) &&
														objtem.getString("var2").equals(var2)&&
														objtem.getString("var3").equals(var3)){
