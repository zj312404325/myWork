...
public class ServiceCenterActivity extends ButtomTapActivity implements IXListViewListener {
    ...
    public class ProSimpleAdapter  extends SimpleAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.tv_centerName.setText(myMaps.get(position).get("name").toString());
            holder.tv_address.setText(myMaps.get(position).get("province").toString()+myMaps.get(position).get("city").toString()+myMaps.get(position).get("district").toString()+myMaps.get(position).get("address").toString());
            holder.tv_contact.setText(myMaps.get(position).get("contact").toString());
            holder.tv_phone.setText(myMaps.get(position).get("mobile").toString());
            holder.tv_fax.setText(myMaps.get(position).get("fax").toString());
            holder.tv_email.setText(myMaps.get(position).get("postcode").toString());
