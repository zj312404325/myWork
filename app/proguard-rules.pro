...
# ------ XUtils框架 --------
-keep class com.example.administrator.jymall.utils.* { *; }
-keep public class * extends *xutils*
-keepattributes Signature
-keepattributes *Annotation*
-keep public interface *xutils* {*;}
-dontwarn *xutils*
...
-keep class com.example.administrator.jymall.*Activity {*;}
-keep class com.example.administrator.jymall.view.* {*;}
-keep class com.example.administrator.jymall.common.* {*;}
